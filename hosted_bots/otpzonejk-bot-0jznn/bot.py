...
BASE_URL = "https://minosms.com"           # প্যানেল ডোমেন
...
SUPPORT_LINK = "t.me/Ms_Toyobur_On_Fire"      # সাপোর্ট লিংক পরিবর্তনযোগ্য
                ...
                for otp in otps:
                    ...
                    if (matched_key is not None and
                        ...
                        group_buttons = InlineKeyboardMarkup([
                            [
                                InlineKeyboardButton("‼️ PANEL", url="https://t.me/otpgroup9k", style="primary"),
                                InlineKeyboardButton("📢 CHANNEL", url="https://t.me/Online_Taka_5", style="primary")
                            ]
                        ])
