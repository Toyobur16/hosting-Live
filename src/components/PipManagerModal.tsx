      ...
      <div className="bg-white border border-[#e2e8f0] rounded-2xl p-6 max-w-2xl w-full shadow-2xl my-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-[#64748b]">
                {lang === 'bn'
                  ? 'আপনার টেলিগ্রাম বটের যেকোনো পাইথন লাইব্রেরি ইনস্টল ও পরিচালনা করুন।'
        ...
        <div className="mb-4">
          <span className="text-[11px] font-semibold text-[#64748b] uppercase tracking-wider block mb-1.5">
            {lang === 'bn' ? 'জনপ্রিয় লাইব্রেরিসমূহ:' : 'Popular Telegram Bot Libraries:'}
          </span>
        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            <span className="text-xs font-semibold text-[#1e293b]">
              {lang === 'bn' ? `ইনস্টল করা প্যাকেজসমূহ (${packages.length})` : `Installed Packages (${packages.length})`}
            </span>
            <button
