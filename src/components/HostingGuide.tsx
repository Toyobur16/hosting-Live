        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div className="max-w-xl">
            <span className="px-3 py-1 rounded-full text-xs font-semibold bg-emerald-50 text-emerald-700 border border-emerald-200 uppercase tracking-wider flex items-center gap-1.5 w-fit">
              ...
              {lang === 'bn' ? '২৪/৭ আনলিমিটেড লাইভ সুরক্ষা' : '24/7 Unlimited Live Protection'}
            </span>
            <h2 className="text-lg sm:text-xl font-bold text-[#1e293b] mt-2.5">
              {botName ? `${botName} • ` : ''}
              {lang === 'bn'
                ? 'আপনি অফলাইনে গেলেও বট ব্যাকগ্রাউন্ডে ২৪/৭ লাইভ থাকবে'
                : 'Your Bot Runs 24/7 Online Even When You Are Offline'}
            </h2>
            <p className="text-xs sm:text-sm text-[#64748b] mt-1.5 leading-relaxed">
              {lang === 'bn'
                ? 'BotHost ক্লাউড ইঞ্জিনের সাথে ব্যাকগ্রাউন্ড অটো-রিস্টার্ট ওয়াচডগ যুক্ত আছে। তাই আপনি ব্রাউজার বন্ধ করলেও বট অনলাইনে সচল থাকবে। ১০০% গ্যারান্টিযুক্ত আপটাইমের জন্য নিচের কিপ-অ্যালাইভ URL টি UptimeRobot বা Cron-job এ যুক্ত করতে পারেন।'
                : 'BotHost cloud runner keeps processes running detached in the background. If a script exits, our watchdog revives it immediately. Add the Keep-Alive URL to any free uptime pinger for guaranteed 24/7 continuity.'}
            </p>
          </div>
          ...
          >
            ...
            <span>{lang === 'bn' ? 'বট প্যাক (.ZIP) ডাউনলোড' : 'Download Bot Pack (.ZIP)'}</span>
          </button>
        </div>
        ...
        <div className="mt-5 pt-4 border-t border-[#f1f5f9] flex flex-wrap items-center justify-between gap-3 bg-[#f8fafc] p-3.5 rounded-xl border border-[#e2e8f0]">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-[#1e293b] font-medium">
              {lang === 'bn' ? '২৪/৭ কিপ-অ্যালাইভ পিং URL (UptimeRobot এর জন্য):' : '24/7 Keep-Alive Ping URL (for UptimeRobot):'}
            </span>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        ...
        <div className="bg-white border border-[#e2e8f0] rounded-2xl p-5 shadow-xs flex flex-col justify-between">
          <div>
            ...
            <p className="text-xs text-[#64748b] leading-relaxed mb-3">
              {lang === 'bn'
                ? 'Render-এ Background Worker হিসেবে হোস্ট করুন। Procfile ও requirements.txt ডাউনলোড করা জিপে রেডি আছে।'
            ...
            <ol className="text-xs text-[#64748b] list-decimal list-inside space-y-1 bg-[#f8fafc] p-3 rounded-xl border border-[#e2e8f0]">
              <li>GitHub এ রিপোজিটরি আপলোড করুন</li>
        ...
        <div className="bg-white border border-[#e2e8f0] rounded-2xl p-5 shadow-xs flex flex-col justify-between">
          <div>
            ...
            <p className="text-xs text-[#64748b] leading-relaxed mb-3">
              {lang === 'bn'
                ? 'Koyeb ক্লাউডে ফ্রিতে ২৪/৭ মাইক্রো ইনস্ট্যান্স চালানো যায়। GitHub কানেক্ট করে ১ ক্লিকে ডিপ্লয় করুন।'
                : 'Zero-downtime micro-instances. Connect GitHub and deploy with native Python runtime.'}
            </p>
            <ol className="text-xs text-[#64748b] list-decimal list-inside space-y-1 bg-[#f8fafc] p-3 rounded-xl border border-[#e2e8f0]">
              <li>Koyeb এ একাউন্ট খুলুন</li>
              <li>GitHub Repo লিঙ্ক করুন</li>
        ...
        <div className="bg-white border border-[#e2e8f0] rounded-2xl p-5 shadow-xs flex flex-col justify-between">
          <div>
            ...
            <p className="text-xs text-[#64748b] leading-relaxed mb-3">
              {lang === 'bn'
                ? 'যেকোনো সার্ভারে PM2 বা Systemd ব্যবহার করে স্থায়ীভাবে ব্যাকগ্রাউন্ডে বট রান করুন।'
          ...
          <div className="mt-4 py-2 text-center text-xs text-[#64748b] font-medium">
            {lang === 'bn' ? 'স্থায়ী ২৪/৭ নিরবচ্ছিন্ন সেবা' : 'Continuous 24/7 Service'}
          </div>
        </div>
      </div>
    </div>
