  ...
  const handleSendBroadcast = async () => {
    ...
    try {
      ...
      if (data.success) {
        setResult(
          lang === 'bn'
            ? `বার্তাটি পাঠানো হয়েছে (${data.totalRecipients} জন ব্যবহারকারীর কাছে)`
    ...
    <div className="fixed inset-0 bg-black/40 backdrop-blur-xs flex items-center justify-center p-4 z-50">
      <div className="bg-white border border-[#e2e8f0] rounded-2xl p-6 max-w-lg w-full shadow-xl">
        <div className="flex items-center justify-between pb-3.5 border-b border-[#f1f5f9] mb-4">
          <div className="flex items-center gap-2.5">
            ...
            <h3 className="text-sm font-bold text-[#1e293b]">
              {lang === 'bn' ? 'অ্যাডমিন ব্রডকাস্ট নোটিশ' : 'Send Admin Broadcast'}
            </h3>
          </div>
        ...
        <p className="text-xs text-[#64748b] mb-3 leading-relaxed">
          {lang === 'bn'
            ? 'এই বার্তাটি আপনার বটের সকল ব্যবহারকারীর টেলিগ্রামে নোটিফিকেশন হিসেবে পৌঁছে যাবে।'
        ...
        <div className="mb-4">
          <textarea
            ...
            placeholder={
              lang === 'bn'
                ? 'ঘোষণার বার্তা লিখুন... (HTML ফরম্যাট সমর্থিত, যেমন: <b>বোল্ড</b>, <code>কোড</code>)'
